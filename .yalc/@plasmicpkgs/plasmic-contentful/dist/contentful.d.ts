...
export declare function ContentfulFetcher({ filterField, filterValue, searchOperator, noAutoRepeat, contentType, children, className, limit, noLayout, setControlContextData, }: ContentfulFetcherProps): JSX.Element;
